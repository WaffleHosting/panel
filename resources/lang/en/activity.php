...
return [
    ...
    'server' => [
        'reinstall' => 'ติดตั้งเซิฟเวอร์ใหม่เรียบร้อยแล้ว',
        'console' => [
            'command' => 'ดำเนินการ ":command" บนเซิฟเวอร์',
        ],
        'power' => [
            'start' => 'เปิดเซิฟเวอร์แล้ว',
            'stop' => 'ปิดเซิฟเวอร์แล้ว',
            'restart' => 'รีสตาร์ทเซิฟเวอร์แล้ว',
            'kill' => 'บังคับปิดเซิฟเวอร์แล้ว',
        ],
        'backup' => [
            'download' => 'ดาวโหลดข้อมูลสำรอง :name เรียบร้อยแล้ว',
        ...
        'database' => [
            ...
            'rotate-password' => 'รหัสผ่านหมุนเวียนสำหรับฐานข้อมูล :name',
        ...
        'sftp' => [
            ...
            'rename_one' => 'เปลี่ยนชื่อ :files.0.from เป็น :files.0.to',
