...
const StartupContainer = () => {
  ...
  return !data ? (
    ...
    <ServerContentBlock title={"เริ่มต้น"} showFlashKey={"startup:image"}>
      <div css={tw`md:flex`}>
        <TitledGreyBox title={"คำสั่งเริ่มต้นการทำงาน"} css={tw`flex-1`}>
          <div css={tw`px-1 py-2`}>
            <p css={tw`font-mono bg-[#060606] rounded py-2 px-4`}>{data.invocation}</p>
          </div>
        </TitledGreyBox>
      ...
      <h3 css={tw`mt-8 mb-2 text-2xl`}>ตัวแปร</h3>
