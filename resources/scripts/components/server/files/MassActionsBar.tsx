...
const MassActionsBar = () => {
  ...
  const onClickCompress = () => {
    setLoading(true);
    clearFlashes("files");
    setLoadingMessage("กำลังบีบอัดไฟล์...");
      ...
      <div css={tw`pointer-events-none fixed bottom-0 z-20 left-0 right-0 flex justify-center`}>
        ...
        >
          <p className={"mb-2"}>
            ...
            <span className={"font-semibold text-gray-50"}>{selectedFiles.length} ไฟล์</span>?
            การดำเนินการนี้เป็นการลบอย่างถาวร และไม่สามารถกู้คืนไฟล์ได้
          </p>
