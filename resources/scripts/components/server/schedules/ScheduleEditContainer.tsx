        ...
        <>
          ...
          <div css={tw`rounded shadow`}>
            ...
            <div css={tw`hidden sm:grid grid-cols-5 md:grid-cols-5 gap-4 mb-4 mt-4`}>
              <CronBox title={"นาที"} value={schedule.cron.minute} />
              <CronBox title={"ชั่วโมง"} value={schedule.cron.hour} />
              <CronBox title={"วัน (เดือน)"} value={schedule.cron.dayOfMonth} />
              <CronBox title={"เดือน"} value={schedule.cron.month} />
              <CronBox title={"วัน (สัปดาห์)"} value={schedule.cron.dayOfWeek} />
            </div>
            <div css={tw`bg-[#070707] rounded-b`}>
