  ...
  <>
    ...
    <div css={tw`flex-1 md:ml-4`}>
      ...
      <p css={tw`text-xs text-neutral-400`}>
        รันครั้งล่าสุด: {schedule.lastRunAt ? format(schedule.lastRunAt, "MMM do 'at' h:mma") : "ไม่เคยทำงาน"}
      </p>
    </div>
    <div>
      <p
      ...
      >
        {schedule.isActive ? "ถูกเปิดใช้งาน" : "ไม่ถูกเปิดใช้งาน"}
      </p>
    </div>
    ...
    <div>
      ...
      >
        {schedule.isProcessing ? "กำลังทำงาน" : schedule.isActive ? "ถูกเปิดใช้งาน" : "ไม่ถูกเปิดใช้งาน"}
      </p>
    </div>
  </>
);
