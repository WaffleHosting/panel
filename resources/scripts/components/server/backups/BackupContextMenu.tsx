...
export default ({ backup }: Props) => {
  ...
  return (
    <>
      ...
      >
        <p>
          เซิร์ฟเวอร์ของคุณจะถูกหยุดการทำงาน คุณจะไม่สามารถควบคุมสถานะเครื่อง, เข้าถึงตัวจัดการไฟล์,
          หรือสร้างการสำรองข้อมูลเพิ่มเติมได้จนกว่าการดำเนินการจะเสร็จสิ้น
        </p>
