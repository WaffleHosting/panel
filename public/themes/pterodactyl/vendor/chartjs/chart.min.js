                    ...
                    g &&
                      ...
                      (s._model = {
                        ...
                        cubicInterpolationMode: o.cubicInterpolationMode
                          ...
                          : a.getValueOrDefault(f.cubicInterpolationMode, c.cubicInterpolationMode),
                        scaleTop: h.top,
              ...
              e.extend(t.Controller.prototype, {
                ...
                eventHandler: function (t) {
                  ...
                  return (
                    ...
                    ("mouseup" === t.type || "click" === t.type) && n.onClick && n.onClick.call(a, t, a.active),
                    ...
                    i.model.skip ||
                      ...
                      (o.almostEquals(i.deltaK, 0, this.EPSILON)
                        ...
                        : ((s = i.mK / i.deltaK),
                          ...
                          9 >= c || ((u = 3 / Math.sqrt(c)), (i.mK = s * u * i.deltaK), (n.mK = d * u * i.deltaK))));
                var h;
                for (e = 0; l > e; ++e)
                  (i = r[e]),
                    i.model.skip ||
                ...
                function l(t) {
                  t.isHorizontal()
                    ? ((t.left = t.options.fullWidth ? s : C),
                      ...
                      (t.bottom = F + t.height),
                      (F = t.bottom))
                    : ((t.left = P), (t.right = P + t.width), (t.top = D), (t.bottom = D + S), (P = t.right));
                }
                if (t) {
                  var s = 0,
                    d = 0,
                    ...
                    if (((r.font = h), p)) {
                      ...
                      (r.textAlign = "left"),
                        ...
                        e.each(a.legendItems, function (t, e) {
                          ...
                          m[m.length - 1] + o + n.padding >= a.width && ((b += d + n.padding), (m[m.length] = a.left)),
                  ...
                  if (i.display) {
                    ...
                    e.each(a.legendItems, function (t, e) {
                      var i = u.measureText(t.text).width,
                        ...
                        c = d.y;
                      k
                        ? r + o >= l && ((c = d.y += S), d.line++, (r = d.x = a.left + (l - s[d.line]) / 2))
                        : c + S > a.bottom &&
                ...
                draw: function (a) {
                  ...
                  if (n.display) {
                    ...
                    if (
                      ...
                      e.each(F, function (t) {
                        if (
                          ...
                          var a = t.label;
                          if (e.isArray(a))
                            for (var i = 0, n = -(a.length - 1) * m * 0.75; i < a.length; ++i)
                    ...
                    if (u.drawBorder) {
                      ...
                      g
                        ? ((E = U = "top" === n.position ? i.bottom : i.top), (E += q), (U += q))
                        : ((N = H = "left" === n.position ? i.right : i.left), (N += q), (H += q)),
                        l.beginPath(),
                        l.moveTo(N, E),
                        l.lineTo(H, U),
                        l.stroke();
              ...
              (t.Tooltip = t.Element.extend({
                ...
                drawCaret: function (t, e, a) {
                  var i,
                    ...
                    x = e.height;
                  "center" === p
                    ? ("left" === g ? ((i = m), (o = i - h), (r = i)) : ((i = m + v), (o = i + h), (r = i)),
                      (s = b + x / 2),
                      (l = s - h),
                      (d = s + h))
                    : ("left" === g
                      ...
                      n.each(r.before, c),
                        n.each(r.lines, function (r) {
                          h &&
                            ...
                            (a.strokeStyle = n.color(e.labelColors[l].borderColor).alpha(i).rgbaString()),
                            a.strokeRect(t.x, t.y, o, o),
                            (a.fillStyle = n.color(e.labelColors[l].backgroundColor).alpha(i).rgbaString()),
                  ...
                  for (
                    ...
                    (h = d[c]),
                      ...
                      0 === c
                        ...
                        : ((f = -1 === u ? f : d[u]),
                          g.skip || ((u !== c - 1 && !o) || -1 === u ? s.moveTo(g.x, g.y) : t(f, h), (u = c)));
                  s.stroke(), s.restore();
                },
              }));
          };
              ...
              (t.elements.Point = t.Element.extend({
                ...
                draw: function () {
                  ...
                  n.skip ||
                    ...
                    (o.lineWidth = e.getValueOrDefault(n.borderWidth, a.elements.point.borderWidth)),
              ...
              i = t.Scale.extend({
                ...
                determineDataLimits: function () {
                  ...
                  void 0 !== t.options.ticks.min &&
                    ((i = e.indexOf(a, t.options.ticks.min)), (t.minIndex = -1 !== i ? i : t.minIndex)),
                    void 0 !== t.options.ticks.max &&
                      ((i = e.indexOf(a, t.options.ticks.max)), (t.maxIndex = -1 !== i ? i : t.maxIndex)),
                    (t.min = a[t.minIndex]),
                    (t.max = a[t.maxIndex]);
                },
                buildTicks: function () {
                ...
                getPixelForValue: function (t, e, a, i) {
                  ...
                  if (n.isHorizontal()) {
                    ...
                    return (
                      ((n.options.gridLines.offsetGridLines && i) || (n.maxIndex === n.minIndex && i)) && (u += d / 2),
                      n.left + Math.round(u)
                    );
                  }
            ...
            t.LinearScaleBase = t.Scale.extend({
              ...
              buildTicks: function () {
                ...
                i.push(void 0 !== n.max ? n.max : c),
                  ...
                  (t.max = e.max(i)),
                  (t.min = e.min(i)),
                  n.reverse ? (i.reverse(), (t.start = t.max), (t.end = t.min)) : ((t.start = t.min), (t.end = t.max));
              },
              convertTicksToLabels: function () {
                var e = this;
              ...
              i = t.Scale.extend({
                ...
                buildTicks: function () {
                  for (
                    ...
                    var l, s;
                    0 === r
                      ? ((l = Math.floor(e.log10(t.minNotZero))), (s = Math.round(t.minNotZero / Math.pow(10, l))))
                            ...
                            ? ((n = e.log10(o.start) - e.log10(o.minNotZero)),
                              (i =
                                l === o.end
                                  ...
                                  : l === o.minNotZero
                                  ? o.top + s + 0.02 * a
                                  : o.top + s + 0.02 * a + ((0.98 * a) / n) * (e.log10(l) - e.log10(o.minNotZero))))
                            : ((n = e.log10(o.end) - e.log10(r)),
                              (a = o.height - (s + d)),
                          ...
                          : ((n = e.log10(o.end) - e.log10(o.minNotZero)),
                            (i =
                              l === r
                                ...
                                : l === o.minNotZero
                                ? o.bottom - d - 0.02 * a
                                : o.bottom - d - 0.02 * a - ((0.98 * a) / n) * (e.log10(l) - e.log10(o.minNotZero))))),
                    i
                  );
                },
                getValueForPixel: function (t) {
                            ...
                            ? e.each(
                                ...
                                function (e) {
                                  ...
                                  a.isValid() &&
                                    ...
                                    r.push(a),
                                    l &&
                                      ((t.firstTick = null !== t.firstTick ? i.min(t.firstTick, a) : a),
                  ...
                  buildTicks: function () {
                    ...
                    if (
                      ...
                      for (var g = 0, p = a.units[g]; g < a.units.length; ) {
                        if (
                          ((i.unitScale = 1), e.isArray(p.steps) && Math.ceil(i.scaleSizeInUnits / f) < e.max(p.steps))
                        ) {
