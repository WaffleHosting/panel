define("ace/keyboard/vim", [
  ...
  function ir(e) {
    ...
    return (
      Object.keys(e).forEach(function (n) {
        var r = e[n];
        Array.isArray(r) ? (r = r.slice()) : r && typeof r == "object" && r.constructor != Object && (r = ir(r)),
          (t[n] = r);
      }),
  ...
  var ht = {
      matchCommand: function (e, t, n, r) {
        ...
        return s.keys.slice(-11) == "<character>" && (n.selectedCharacter = Ct(e)), { type: "full", command: s };
      },
      ...
      sort: function (e, t) {
        ...
        function b(e, t) {
          ...
          var o = s && p.exec(e),
            u = s && p.exec(t);
          return o
            ? ((o = parseInt((o[1] + o[2]).toLowerCase(), d)), (u = parseInt((u[1] + u[2]).toLowerCase(), d)), o - u)
            : e < t
            ? -1
            : 1;
        }
        ...
        var l = E(a, 0),
          ...
          p =
            s == "decimal" ? /(-?)([\d]+)/ : s == "hex" ? /(-?)(?:0x)?([0-9a-f]+)/i : s == "octal" ? /([0-7]+)/ : null,
